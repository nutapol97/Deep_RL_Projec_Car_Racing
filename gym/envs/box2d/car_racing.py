...
def default_reward_callback(env):
    ...
    #    reward -= HARD_NEG_REWARD
        ...
        x1=  env._get_position_inside_lane(x, x_pos=1, border=True, direction=1, discrete=False)
        x2 = env._get_position_inside_lane(x, x_pos=1, border=True, direction=-1, discrete=False)
